...
from .views import tag_list, tag_detail, startup_list, startup_detail, TagCreate, StartupCreate
from .views import NewsLinkUpdate, NewsLinkCreate, TagUpdate, StartupUpdate, NewsLinkDelete, TagDelete, StartupDelete
